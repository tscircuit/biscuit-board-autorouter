...
import capturedInput from "./fixtures/repro03-stm32-display-user-led.srj.json";
 ...
 * algorithmFn boundary. Repro 03 focuses on irregular routing near R_USER_LED.
 */
export default function Repro03Page() {
  return (
    <div style={{ fontFamily: "sans-serif" }}>
      <header style={{ padding: "12px 16px" }}>
        <strong>Repro 03 · STM32 display board R_USER_LED traces</strong>
